      ...
      <div className="hero-wrapper">
        ...
        <div className="hero-container">
          <div className="hero-left">
            <span className="hero-badge"> Curated Interview Questions</span>
            <h1 className="main-title">
              Practice Like It's the Real Interview.
            </h1>

            <p className="main-text">
              Welcome to Interview Helper! Answer questions for mastering
              role-specific interview questions one flashcard at a time. Whether
              you're aiming to become a Scrum Product Owner, Scrum Master, UI/UX
              Designer, Web Developer, or Python Developer, this will help you.
            </p>
              ...
              {selectedOption && (
                <p
                  style={{
                    ...
                    fontWeight: "700",
                    color:
                      selectedOption === correctAnswer ? "#10b981" : "#ef4444",
                  }}
                >
        ...
        <section className="how-it-works">
          ...
          <div className="how-grid">
            ...
            <div className="how-card">
              <h3>Error Limit</h3>
              <p>
                If you miss a question, you’ll have up to three tries to get it
                right.
              </p>
            </div>
            <div className="how-card">
              ...
              <p>
                At the end a summary of how well you did will be shown to you
              </p>
            </div>
          </div>
        </section>
